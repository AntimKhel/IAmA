...
val BotPeekLeftStyle = CssStyle {
    ...
    Breakpoint.LG { Modifier.display(DisplayStyle.Block) }
}
...
fun AndroidBotRight() {
    ...
    Svg(
            attrs =
                    BotPeekRightStyle.toModifier().toAttrs {
                        width(80)
                        height(100)
                        viewBox(0, 0, 80, 100)
                    }
        ...
        Circle(
                attrs = {
                    ...
                    cy(38)
                    r(5)
                    fill(com.varabyte.kobweb.compose.ui.graphics.Colors.White)
                }
        )
        Circle(
                attrs = {
        ...
        Circle(
                attrs = {
                    ...
                    cy(37)
                    r(2)
                    fill(com.varabyte.kobweb.compose.ui.graphics.Colors.Black)
                }
        )
        Circle(
                attrs = {
...
fun AndroidBotLeft() {
    ...
    Svg(
            attrs =
                    BotPeekLeftStyle.toModifier().toAttrs {
                        width(60)
                        height(75)
                        viewBox(0, 0, 80, 100)
                    }
